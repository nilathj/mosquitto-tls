...
Refer https://home-assistant.io/docs/mqtt/broker/#run-your-own for all the config options.  Your HA will communicate with mosquitto server using 127.0.0.1:1883 without any certificates.
